...
let rex = new Dino('Tyranosaurus', 'Carnivorous', '7000kg', '12m', 'Late Cretaceious');
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let steg = new Dino('Stegosaurus', 'Herbivorous', '2000kg', '9m', 'Late Jurassic');
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceious
let raptor = new Dino('Velociraptor', 'Carnivorous', '15kg', '1.8m', 'Late Cretaceious');
...
rex.roar = function () { return "RAWERSRARARWERSARARARRRR!"; };
